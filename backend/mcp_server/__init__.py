"""Kallipolis MCP server — a read-only Model Context Protocol adapter.
...
Shared infrastructure, not an ontology unit: it wraps existing capability and
introduces no new graph model. See ``research/mcp-server/requirements.md`` for
the governing spec and the plan file for the architecture.
"""
