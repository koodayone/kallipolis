...
class QualifiedValue(BaseModel):
    """A datum bound to its qualifier stamp (source · granularity · vintage).
    ...
    ``parent_vintages`` (K4/CI-06) carries a derived figure's parent windows; empty until populated.
    """
