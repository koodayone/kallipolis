...
def q(field: str, value, *, granularity: str, unit: str = "",
    ...
    Pass an explicit ``vintage`` for data-derived windows (awards/wage); otherwise the
    file-level default is used. A non-ok ``status`` yields an explicit epistemic marker (value None)."""
