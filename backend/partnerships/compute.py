...
def main():
    """CLI entrypoint for ad-hoc PARTNERSHIP_ALIGNMENT materialization (e.g. on
    prod after a code change that needs fresh edges without a full reload).
    College→Employer, per-college batched; gated by --college (or --all)."""
    parser = argparse.ArgumentParser(
        description="Materialize PARTNERSHIP_ALIGNMENT edges.",
    )
