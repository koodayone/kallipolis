...
.alg-dense .chip{min-width:66px;box-sizing:border-box;text-align:center}
.alg-quote{font-size:10px;color:#5a6577;line-height:1.35;margin-top:2px;padding-left:2px}.alg-sec{display:inline-block;min-width:126px;box-sizing:border-box;font-size:9px;font-weight:600;color:#6b7686;border:1px solid #dde2ea;border-radius:3px;padding:0 4px;margin-right:5px;vertical-align:0}
