...
//
// The data lives in a sibling JSON file so the TypeScript module stays small
// and the data is easy to regenerate. The schema must match
...
import seedData from "./seededPartnerships.json";
...
const SEEDED_BY_NAME: Record<string, SavedProposal[]> =
  seedData as unknown as Record<string, SavedProposal[]>;
