...
const COLLEGE_IDS = landscapeInstance("smccd-edhd").collegeIds;

export default function SmccdEdhdReportRoute() {
  ...
  return (
    ...
    >
      <LandscapeReport colleges={colleges} instance="smccd-edhd" />
    </motion.div>
  );
}
