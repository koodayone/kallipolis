...
const COLLEGE_IDS = landscapeInstance("smccd-atl").collegeIds;

export default function SmccdAtlReportRoute() {
  ...
  return (
    ...
    >
      <LandscapeReport colleges={colleges} instance="smccd-atl" />
    </motion.div>
  );
}
