...
const COLLEGE_IDS = landscapeInstance("smccd-adm").collegeIds;

export default function SmccdAdmReportRoute() {
  ...
  return (
    ...
    >
      <LandscapeReport colleges={colleges} instance="smccd-adm" />
    </motion.div>
  );
}
