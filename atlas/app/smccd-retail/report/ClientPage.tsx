...
const COLLEGE_IDS = landscapeInstance("smccd-retail").collegeIds;

export default function SmccdRetailReportRoute() {
  ...
  return (
    ...
    >
      <LandscapeReport colleges={colleges} instance="smccd-retail" />
    </motion.div>
  );
}
