...
const COLLEGE_IDS = landscapeInstance("smccd-ecu").collegeIds;

export default function SmccdEcuReportRoute() {
  ...
  return (
    ...
    >
      <LandscapeReport colleges={colleges} instance="smccd-ecu" />
    </motion.div>
  );
}
