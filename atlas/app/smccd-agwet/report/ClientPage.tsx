...
const COLLEGE_IDS = landscapeInstance("smccd-agwet").collegeIds;

export default function SmccdAgwetReportRoute() {
  ...
  return (
    ...
    >
      <LandscapeReport colleges={colleges} instance="smccd-agwet" />
    </motion.div>
  );
}
