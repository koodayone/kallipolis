...
const COLLEGE_IDS = landscapeInstance("smccd-public_safety").collegeIds;

export default function SmccdPublicSafetyReportRoute() {
  ...
  return (
    ...
    >
      <LandscapeReport colleges={colleges} instance="smccd-public_safety" />
    </motion.div>
  );
}
