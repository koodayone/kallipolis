...
const REQUIREMENTS = [
  "Regional labor market and wage trend data",
  "Emerging occupation and skills gap analysis",
  "Industry sector growth projections",
  "CTE program enrollment and completion data",
  "Statewide and regional economic reports",
];
...
export default function ResearchView({ school, onBack }: Props) {
  return (
    <div
      style={{
        maxWidth: "800px",
    ...
    >
      ...
      <div>
        ...
        >
          Synthesizes regional labor market intelligence and emerging sector data to inform
          curriculum development, program prioritization, and strategic planning for CTE.
        </p>
      </div>
