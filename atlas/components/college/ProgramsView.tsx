...
const REQUIREMENTS = [
  "Degree and certificate award records",
  "Program-level learning outcome assessments",
  "Enrollment by program and TOP code",
  "Program review cycle documentation",
  "FTES and FTEF by program",
];
...
export default function ProgramsView({ school, onBack }: Props) {
  return (
    <div
      style={{
        maxWidth: "800px",
    ...
    >
      ...
      <div>
        ...
        >
          Surfaces degree and certificate performance, program review health, and award outcomes
          across the full catalog. Feeds accreditation, LARC, and Chancellor's Office reporting cycles.
        </p>
      </div>
