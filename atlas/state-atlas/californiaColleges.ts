...
export const CALIFORNIA_REGIONS: Region[] = [
  ...
  },
  {
    ...
    labelCenter: [-121.5, 39.1],
    zoomCenter: [-121.0, 39.2],
    scale: 8000,
    counties: ["Butte", "Glenn", "Colusa", "Yolo", "Sacramento", "Sutter", "Yuba"],
    collegeCount: 7,
  },
  {
    id: "sierra-nevada",
    name: "Sierra Nevada",
    labelCenter: [-120.0, 38.35],
    zoomCenter: [-120.2, 38.5],
    scale: 7000,
    counties: ["Plumas", "Sierra", "Nevada", "Placer", "El Dorado", "Alpine", "Amador", "Calaveras", "Tuolumne", "Mariposa"],
    collegeCount: 5,
  },
  {
    id: "bay-area",
    name: "Bay Area",
    labelCenter: [-122.3, 37.75],
    zoomCenter: [-122.1, 37.7],
    scale: 11000,
    counties: ["Marin", "Sonoma", "Napa", "Lake", "Solano", "Contra Costa", "Alameda", "San Francisco", "San Mateo", "Santa Clara", "Santa Cruz"],
    collegeCount: 26,
  },
  {
    id: "central-valley",
    name: "Central Valley",
    labelCenter: [-119.6, 36.5],
    zoomCenter: [-119.4, 37.3],
    scale: 7000,
    counties: ["San Joaquin", "Stanislaus", "Merced", "Fresno", "Madera", "Kings", "Tulare", "Kern"],
    collegeCount: 14,
  },
  {
    id: "desert",
    name: "Desert",
    labelCenter: [-117.8, 37.0],
    zoomCenter: [-117.8, 37.0],
    scale: 5500,
    counties: ["Mono", "Inyo"],
    collegeCount: 0,
  },
...
export const CALIFORNIA_COLLEGES: College[] = [
  ...
  // Greater Sacramento
  { id: "butte",          name: "Butte College",                   district: "Butte-Glenn CCD",               regionId: "greater-sacramento", lat: 39.52, lng: -121.65, logoStacked: "/butte-logo.svg" },
  { id: "sierra",         name: "Sierra College",                  district: "Sierra JCCD",                   regionId: "sierra-nevada",      lat: 38.79, lng: -121.20, logoStacked: "/sierra-logo.png" },
  { id: "saccc",          name: "Sacramento City College",         district: "Los Rios CCD",                  regionId: "greater-sacramento", lat: 38.56, lng: -121.49, logoStacked: "/saccc-logo.svg" },
  { id: "arc",            name: "American River College",          district: "Los Rios CCD",                  regionId: "greater-sacramento", lat: 38.67, lng: -121.37, logoStacked: "/arc-logo.svg" },
  { id: "cosumnes",       name: "Cosumnes River College",          district: "Los Rios CCD",                  regionId: "greater-sacramento", lat: 38.44, lng: -121.42, logoStacked: "/cosumnes-logo.svg" },
  { id: "folsom",         name: "Folsom Lake College",             district: "Los Rios CCD",                  regionId: "greater-sacramento", lat: 38.67, lng: -121.17, logoStacked: "/folsom-logo.svg" },
  { id: "nevada",         name: "Nevada Union / Gold Hill",        district: "Nevada-Sierra CCD",             regionId: "sierra-nevada",      lat: 39.29, lng: -121.06 },
  { id: "yuba",           name: "Yuba College",                    district: "Yuba CCD",                      regionId: "greater-sacramento", lat: 39.14, lng: -121.62, logoStacked: "/yuba-logo.png" },
  { id: "woodland",       name: "Woodland Community College",      district: "Yuba CCD",                      regionId: "greater-sacramento", lat: 38.66, lng: -121.73, logoStacked: "/woodland-logo.svg" },
  { id: "laketahoe",      name: "Lake Tahoe Community College",    district: "Lake Tahoe CCD",                regionId: "sierra-nevada",      lat: 38.93, lng: -119.97, logoStacked: "/laketahoe-logo.png" },
  ...
  { id: "sanjoquin",      name: "San Joaquin Delta College",       district: "San Joaquin Delta CCD",         regionId: "central-valley",     lat: 37.96, lng: -121.29, logoStacked: "/sanjoquin-logo.jpg" },
  { id: "westhill",       name: "West Hills College Coalinga",     district: "West Hills CCD",                regionId: "central-valley",     lat: 36.15, lng: -120.35, logoStacked: "/westhill-logo.svg" },
  { id: "westhillslemo",  name: "West Hills College Lemoore",      district: "West Hills CCD",                regionId: "central-valley",     lat: 36.30, lng: -119.78, logoStacked: "/westhillslemo-logo.svg" },
  { id: "bakersfield",   name: "Bakersfield College",              district: "Kern CCD",                      regionId: "central-valley",     lat: 35.41, lng: -118.97, logoStacked: "/bakersfield-logo.png" },
  { id: "cerrocoso",     name: "Cerro Coso Community College",     district: "Kern CCD",                      regionId: "central-valley",     lat: 35.57, lng: -117.66, logoStacked: "/cerrocoso-logo.png" },
  { id: "porterville",   name: "Porterville College",              district: "Kern CCD",                      regionId: "central-valley",     lat: 36.05, lng: -119.01, logoStacked: "/porterville-logo.png" },
  { id: "taft",          name: "Taft College",                     district: "West Kern CCD",                 regionId: "central-valley",     lat: 35.14, lng: -119.46, logoStacked: "/taft-logo.png" },
  { id: "madera",        name: "Madera Community College",         district: "State Center CCD",              regionId: "central-valley",     lat: 36.96, lng: -120.06, logoStacked: "/madera-logo.png" },

  // Central Coast
  { id: "cuesta",         name: "Cuesta College",                  district: "San Luis Obispo CCD",           regionId: "central-coast",      lat: 35.32, lng: -120.66, logoStacked: "/cuesta-logo.png" },
  { id: "sbcc",           name: "Santa Barbara City College",      district: "Santa Barbara CCD",             regionId: "central-coast",      lat: 34.43, lng: -119.72, logoStacked: "/sbcc-logo.png" },
  { id: "hancock",        name: "Allan Hancock College",           district: "Allan Hancock JCCD",            regionId: "central-coast",      lat: 34.90, lng: -120.43, logoStacked: "/hancock-logo.png" },
  { id: "hartnell",       name: "Hartnell College",                district: "Hartnell CCD",                  regionId: "central-coast",      lat: 36.67, lng: -121.63, logoStacked: "/hartnell-logo.svg" },
  { id: "montereypen",    name: "Monterey Peninsula College",      district: "Monterey Peninsula CCD",        regionId: "central-coast",      lat: 36.60, lng: -121.87, logoStacked: "/montereypen-logo.png" },
  { id: "cabrillovc",     name: "Ventura College",                 district: "Ventura CCD",                   regionId: "central-coast",      lat: 34.28, lng: -119.22, logoStacked: "/cabrillovc-logo.png" },
  { id: "oxnard",         name: "Oxnard College",                  district: "Ventura CCD",                   regionId: "central-coast",      lat: 34.22, lng: -119.18, logoStacked: "/oxnard-logo.png" },
  { id: "moorpark",       name: "Moorpark College",                district: "Ventura CCD",                   regionId: "central-coast",      lat: 34.28, lng: -118.88, logoStacked: "/moorpark-logo.png" },

  // Inland Empire
  { id: "desert",         name: "College of the Desert",           district: "Desert CCD",                    regionId: "inland-empire",      lat: 33.73, lng: -116.37, logoStacked: "/desert-logo.png" },
  { id: "sbvalley",       name: "San Bernardino Valley College",   district: "San Bernardino CCD",            regionId: "inland-empire",      lat: 34.10, lng: -117.29, logoStacked: "/sbvalley-logo.png" },
  { id: "crafton",        name: "Crafton Hills College",           district: "San Bernardino CCD",            regionId: "inland-empire",      lat: 34.06, lng: -117.05, logoStacked: "/crafton-logo.png" },
  { id: "chaffey",        name: "Chaffey College",                 district: "Chaffey CCD",                   regionId: "inland-empire",      lat: 34.10, lng: -117.66, logoStacked: "/chaffey-logo.svg" },
  { id: "riverside",      name: "Riverside City College",          district: "Riverside CCD",                 regionId: "inland-empire",      lat: 33.98, lng: -117.37, logoStacked: "/riverside-logo.svg" },
  { id: "norco",          name: "Norco College",                   district: "Riverside CCD",                 regionId: "inland-empire",      lat: 33.93, lng: -117.55, logoStacked: "/norco-logo.png" },
  { id: "msjc",           name: "Mt. San Jacinto College",         district: "Mt. San Jacinto CCD",           regionId: "inland-empire",      lat: 33.75, lng: -117.22, logoStacked: "/msjc-logo.png" },
  { id: "victor",         name: "Victor Valley College",           district: "Victor Valley CCD",             regionId: "inland-empire",      lat: 34.50, lng: -117.29, logoStacked: "/victor-logo.svg" },
  { id: "barstow",        name: "Barstow Community College",       district: "Barstow CCD",                   regionId: "inland-empire",      lat: 34.90, lng: -117.02, logoStacked: "/barstow-logo.svg" },
  { id: "morenovalley",  name: "Moreno Valley College",           district: "Riverside CCD",                 regionId: "inland-empire",      lat: 33.89, lng: -117.20, logoStacked: "/morenovalley-logo.svg" },
  { id: "paloverde",     name: "Palo Verde College",              district: "Palo Verde CCD",                regionId: "inland-empire",      lat: 33.66, lng: -114.65, logoStacked: "/paloverde-logo.png" },
  { id: "coppermtn",     name: "Copper Mountain College",         district: "Copper Mountain CCD",           regionId: "inland-empire",      lat: 34.14, lng: -116.22, logoStacked: "/coppermtn-logo.svg" },
  ...
  { id: "antelopevalley", name: "Antelope Valley College",        district: "Antelope Valley CCD",           regionId: "los-angeles",        lat: 34.68, lng: -118.19, logoStacked: "/antelopevalley-logo.svg" },
  { id: "canyons",       name: "College of the Canyons",          district: "Santa Clarita CCD",             regionId: "los-angeles",        lat: 34.40, lng: -118.57, logoStacked: "/canyons-logo.webp" },
  ...
  // San Diego / Imperial
  { id: "sandiegomesa",   name: "San Diego Mesa College",          district: "San Diego CCD",                 regionId: "san-diego",          lat: 32.80, lng: -117.15, logoStacked: "/sandiegomesa-logo.png" },
  { id: "sandiegocity",   name: "San Diego City College",          district: "San Diego CCD",                 regionId: "san-diego",          lat: 32.71, lng: -117.16, logoStacked: "/sandiegocity-logo.png" },
  { id: "sandiegomira",   name: "San Diego Miramar College",       district: "San Diego CCD",                 regionId: "san-diego",          lat: 32.90, lng: -117.14, logoStacked: "/sandiegomira-logo.svg" },
  { id: "grossmont",      name: "Grossmont College",               district: "Grossmont-Cuyamaca CCD",        regionId: "san-diego",          lat: 32.80, lng: -116.97, logoStacked: "/grossmont-logo.svg" },
  { id: "cuyamaca",       name: "Cuyamaca College",                district: "Grossmont-Cuyamaca CCD",        regionId: "san-diego",          lat: 32.79, lng: -116.97, logoStacked: "/cuyamaca-logo.svg" },
  { id: "palomar",        name: "Palomar College",                 district: "Palomar CCD",                   regionId: "san-diego",          lat: 33.13, lng: -117.06, logoStacked: "/palomar-logo.png" },
  { id: "miracostacc",    name: "MiraCosta College",               district: "MiraCosta CCD",                 regionId: "san-diego",          lat: 33.15, lng: -117.27, logoStacked: "/miracostacc-logo.svg" },
  { id: "imperial",       name: "Imperial Valley College",         district: "Imperial CCD",                  regionId: "san-diego",          lat: 32.79, lng: -115.55, logoStacked: "/imperial-logo.png" },
  { id: "southwestern",  name: "Southwestern College",            district: "Southwestern CCD",              regionId: "san-diego",          lat: 32.64, lng: -117.00, logoStacked: "/southwestern-logo.png" },
  { id: "sdcce",         name: "SD College of Continuing Ed",     district: "San Diego CCD",                 regionId: "san-diego",          lat: 32.70, lng: -117.11, logoStacked: "/sdcce-logo.webp" },
];
