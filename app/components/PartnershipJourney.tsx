...
const STEPS = [
  {
    ...
    prose: "Identify partnership opportunities from a ranked landscape of organizations whose hiring needs align with your curriculum.",
  ...
  },
  {
    ...
    prose: "Every employer is connected to the occupations it hires for — with regional wages, growth rates, and annual openings sourced from the Centers of Excellence.",
  ...
  },
  {
    ...
    prose: "Not a generic list of programs — the specific departments at your college whose coursework develops the skills this employer's occupations require.",
