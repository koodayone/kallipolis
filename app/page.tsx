...
export default function Home() {
  return (
    <main>
      ...
      <Vision />
      <SyncedShowcase />
      <ActionBadge label="Explore Sources" neonColor="#c9a84c" opacity={1} icon="lightbulb" />
      <PartnershipsSection />
      <ActionBadge label="Explore Partnerships" neonColor="#b0a0ff" opacity={1} icon="chainlink" />
      <Promise />
