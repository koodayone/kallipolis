...
const formDefs: FormDef[] = [
  { label: "Partnerships",     factory: createChainlinkForm, position: new THREE.Vector3(-3.0, 2.2, 0),  rotSpeed: new THREE.Vector3(0.0018, 0.0025, 0.001) },
  { label: "Strong Workforce", factory: createDumbbellForm,  position: new THREE.Vector3(-3.0, -2.8, 0), rotSpeed: new THREE.Vector3(0.0018, 0.0025, 0.001) },
];
