...
In Kallipolis, a student is a represented person whose competency portrait — primary focus, course history, GPA, and occupation alignment — makes the supply side of workforce development empirical. Each field answers a facet of one question: is this student equipped to enter the workforce in this area, and at what level? Together, the fields turn courses into a measurable production system and turn the labor market into a destination for the institutional pathways that system produces.
...
- **Occupation alignment** says which workforce pathways the student's completed coursework institutionally feeds. Each completed course's TOP code crosswalks to a set of SOC-coded occupations through the Chancellor's Office TOP-CIP and BLS/NCES CIP-SOC mappings. The alignment view ranks the occupations the student aligns with by coverage — the fraction of the college's PREPARES_FOR-aligned courses for that SOC the student has completed. This is a transcript-grounded claim about workforce-pathway preparation, sourced from the institutional crosswalk rather than an LLM-derived skill index.
...
The supply side of workforce development is colleges producing graduates prepared for workforce pathways. Without students, this is rhetoric — an institutional claim that the curriculum prepares capable workers. With students, the claim becomes measurable. The student is the literal carrier of curricular preparation from the supply side, and the four fields are what make the carrying observable. *Course history* shows what teaching the student received; *occupation alignment* shows which workforce pathways the institutional crosswalk says that teaching feeds; *GPA* shows how confidently; *primary focus* shows where the student is taking those preparations.

This is what gives the relational layer of the ontology its empirical character. Courses prepare students for occupations through the institutional TOP-CIP-SOC crosswalk; students enroll in courses; occupations are demanded by employers; employers hire for occupations. The chain is meaningful only because students populate the middle of it. They are the entity that turns "this college institutionally prepares students for SOC X" into "this many students at this college have actually completed coursework that feeds SOC X." Without students, the supply side would be a list of courses and intentions. With students, it becomes a measurable production system.

A coordinator looking at the relational graph is almost always asking a student-mediated question: how many students at my college are prepared for this occupation, how many of them are in programs aligned with this employer, which ones have a primary focus that suggests they would be interested in this partnership opportunity. The four fields are what make those questions answerable.

## How students are generated today

The student records currently in the Kallipolis ontology are synthetic. They are produced by a sophisticated but imperfect methodology that takes a college's actual courses and program structure and synthesizes a population of students whose enrollments and TOP-coded course-taking patterns approximate the institutional reality of that college. The methodology is not a placeholder. It is a deliberate choice with two justifications.

The first is privacy. Real student data is sensitive enough that handling it carries legal, ethical, and operational burdens a product at this stage is not yet equipped to take on. Synthesizing students from validated curricular data lets Kallipolis demonstrate the analytical power of the ontology without becoming a custodian of records that come with FERPA obligations and institutional access agreements.

The second is what the synthetic data lets the system show. Synthetic students illustrate the *art of the possible* — what the system can do when it has student-level evidence to reason about. A coordinator looking at a Kallipolis instance with synthetic students sees a structurally faithful approximation of what they would see with their college's real records, and the analytical capability is the same in both cases.

The legibility obligation is the price of the approach. A user who does not understand the students are synthetic could mistake the population for a literal headcount. A user who does can read the analysis in the right register: a structurally accurate model populated by representative figures rather than identified individuals. The documentation has to make this distinction clear, because it is what allows the synthetic approach to be honest rather than evasive.
...
The four angles — what a student contains, how those contents position them, how they are generated, how they will be represented — are not four competing definitions of a student. They are four layers of one definition: what is *in* a student record, what those contents *do* in the larger logic of the ontology, how the contents are *currently produced*, and how they will be *produced in the future*.

All four are needed because the student form is the only one of the four units of analysis where the gap between the current implementation and the future ambition is large enough to require explicit acknowledgment. Courses, occupations, and employers all use real institutional data today. Students use synthesized data today and real data tomorrow. The form's documentation has to honor both states — the present and the trajectory — without collapsing either one into the other.
